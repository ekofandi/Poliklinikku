        ...
        <tbody>
            <?php 
              ...
              <tr>
                ...
                <td>
                  <a href="dokter.php?page=dokter&id=<?php echo $data['id'] ?>" class="btn btn-success">Ubah</a>
                  <a href="dokter.php?page=dokter&id=<?php echo $data['id'] ?>&aksi=hapus" class="btn btn-danger">Hapus</a>
                </td>
              </tr>     
            <?php 
              }
